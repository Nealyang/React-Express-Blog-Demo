...
const { update_content, update_tags, update_title, save_article, update_summary } = actions;
...
class AdminNewArticle extends Component {
  ...
  publishArticle() {
    ...
    articleData.summary = this.props.content.slice(0, 20) + '...';
...
function mapStateToProps(state) {
  const { title, content, tags, summary } = state.admin.newArticle;
